            ...
            <div key={lightKey} className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-xl border-2 border-gray-300 shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  ...
                  disabled={autoMode}
                  className={`py-3 rounded-lg font-semibold transition-all duration-300 ${lightStates[lightKey] === 'red'
                ...
                <button
                  ...
                  disabled={autoMode}
                  className={`py-3 rounded-lg font-semibold transition-all duration-300 ${lightStates[lightKey] === 'yellow'
                ...
                <button
                  ...
                  disabled={autoMode}
                  className={`py-3 rounded-lg font-semibold transition-all duration-300 ${lightStates[lightKey] === 'green'
